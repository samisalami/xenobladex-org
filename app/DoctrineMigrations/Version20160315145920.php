 ...
 */
class Version20160315145920 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE xenobladex_equipupgrade_tier (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE xenobladex_equipupgrade_tier_material DROP FOREIGN KEY FK_66940918C5FF1223');
        ...
        $this->addSql('DROP TABLE xenobladex_equipupgrade_tier');
